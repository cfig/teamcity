...
android_build_dolphin_110_GMS:
	# vsxxx
	cd $(HOME)/city/$(theCmd)/android_s/vendor/synaptics/vsxxx && git fetch ssh://yyu@gerrit-sha.synaptics.com:29420/by-projects/android/platform/vendor/synaptics/vsxxx refs/changes/08/232908/5 && git cherry-pick FETCH_HEAD
	# v-c
	cd $(HOME)/city/$(theCmd)/android_s/vendor/synaptics/common && git fetch ssh://yyu@gerrit-sha.synaptics.com:29420/by-projects/android/platform/vendor/synaptics/common refs/changes/39/223839/20 && git cherry-pick FETCH_HEAD
	# d-c
	cd $(HOME)/city/$(theCmd)/android_s/device/synaptics/common &&  git fetch ssh://yyu@gerrit-sha.synaptics.com:29420/by-projects/android/device/synaptics/common refs/changes/84/226684/5 && git cherry-pick FETCH_HEAD
	# P
	cd $(HOME)/city/$(theCmd)/android_s/device/synaptics/platypus && git fetch ssh://yyu@gerrit-sha.synaptics.com:29420/by-projects/android/device/synaptics/platypus refs/changes/15/232515/6 && git cherry-pick FETCH_HEAD
	# D
	cd $(HOME)/city/$(theCmd)/android_s/device/synaptics/dolphin && git fetch ssh://yyu@gerrit-sha.synaptics.com:29420/by-projects/android/device/synaptics/dolphin refs/changes/72/232972/7 && git cherry-pick FETCH_HEAD
	# wireless
	...
	# Hoff1
	cd $(HOME)/city/$(theCmd)/android_s/vendor/synaptics/wireless && git fetch ssh://yyu@gerrit-sha.synaptics.com:29420/by-projects/android/platform/vendor/synaptics/wireless refs/changes/74/230774/15 && git cherry-pick FETCH_HEAD
	# Hoff2
	cd $(HOME)/city/$(theCmd)/s/linux_5_4 && git fetch ssh://yyu@gerrit-sha.synaptics.com:29420/debu/common/linux refs/changes/39/238639/3 && git cherry-pick FETCH_HEAD
	# Ya
