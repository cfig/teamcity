...
sdk_post_sync:
	cd $(CITY)/$(theCmd)/s/ && lazybox repo_lfs
...
android_u_aosp_init: | $(CITY)/$(theCmd)/android_u
	cd $(CITY)/$(theCmd)/android_u  && repo init -u ssh://sc-debu-git.synaptics.com:29420/by-projects/android/manifests -b dev_branch/android_u/master -m syna-aosp.xml --depth=1
android_u_aosp_init_114_lts: | $(CITY)/$(theCmd)/android_u
	cd $(CITY)/$(theCmd)/android_u  && repo init -u ssh://sc-debu-git.synaptics.com:29420/by-projects/android/manifests -b rel_branch/vssdk/v1.14/202412051605 -m syna-aosp.xml --depth=100
...
android_b_aosp_init: | $(CITY)/$(theCmd)/android_b
	cd $(CITY)/$(theCmd)/android_b  && repo init -u ssh://sc-debu-git.synaptics.com:29420/by-projects/android/manifests --no-repo-verify -b dev_branch/android_b/master -m syna-aosp.xml
android_b_gms_init: | $(CITY)/$(theCmd)/android_b
	cd $(CITY)/$(theCmd)/android_b  && repo init -u ssh://sc-debu-git.synaptics.com:29420/by-projects/android/manifests --no-repo-verify -b dev_branch/android_b/master -m syna-tv-dev.xml
...
sdk_init_114_lts: | $(CITY)/$(theCmd)/s
	cd $(CITY)/$(theCmd)/s && repo init -u ssh://sc-debu-git.synaptics.com:29420/debu/manifest -b rel_branch/vssdk/v1.14/202412051605 -m vssdk.xml --depth=100
...
android_build_dolphin_B_GMS_36:
	cd $(CITY)/$(theCmd)/android_b && ./vendor/synaptics/build/build_androidtv \
		-p vendor/synaptics/platypus/configs/platypus_bl \
		-m ../s
...
# dolphin_U_trunk_AOSP_34
android_init_dolphin_U_trunk_AOSP_34: android_u_aosp_init
	echo DONE
sdk_init_dolphin_U_trunk_AOSP_34: sdk_init
	echo DONE
android_post_sync_dolphin_U_trunk_AOSP_34:
	echo SKIP
